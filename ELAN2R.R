...
# Филемакер метаданныекӧд. This script reads the content of ELAN files that are 
# in folders under it. It reads only the tiers with the linguistic type wordT, 
# and it joins this data with participant attributes for those tiers + 
# filenames. The script doesn't assume very much about the data, but it requires
